...
Builds will be uploaded in the [Releases](https://github.com/Justus6568/NewPipe/releases) section. Please download the APK from the newest release and install it on your device.
...
## Bugs
Please do not report bugs encountered while using this fork to the upstream developers.
